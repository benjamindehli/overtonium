...
| Rail      | ±5 ct | ±0.5 dB  | three RC stages set the frequency and their errors stack, and the rail sets the level     |
| Diode     | ±4 ct | ±0.4 dB  | an integrator sets the frequency, which is accurate, and two diodes set the level         |
| Valve     | ±6 ct | ±0.35 dB | a heater in every unit and nothing regulating either end of it                            |
| Op-amp    | ±4 ct | ±0.3 dB  | an ordinary amplifier around an ordinary core                                             |

...
Both halves span four octaves of time at full amount. A partial set to 5 ms attacks in 5 ms under a hard blow and takes 80 ms under the softest one, and a 400 ms delay stays 400 ms under the softest and comes in to 25 ms under the hardest. Octaves rather than a straight scaling, because these times are heard in ratios: the step from 5 ms to 10 ms is the audible change that the step from 2 s to 2.005 s is not.

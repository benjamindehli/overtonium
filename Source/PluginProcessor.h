...
// juce_add_plugin defines this for the plugin targets. The headless integration test
// builds the same sources as a console app, where it is absent.
...
public:
    ...
    /** Defined in PluginEditor.cpp so this translation unit stays free of GUI dependencies. */
...
private:
    ...
    /** The engine always writes here first; the host buffer may be mono, stereo or wider. */

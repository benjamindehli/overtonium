...
struct Applier
{
    ...
    void allOsc (const char* suffix, Fn&& fn) const
    {
    ...
    /** Everything a preset does not explicitly set should start from a known state. */
...
void apply (APVTS& apvts, int index)
{
    ...
    switch (index)
    {
        ...
        case 1: // Drawbar Organ
        {
            ...
            // A registration in the spirit of 88 8000 000: octaves and fifths, no sevenths.
        ...
        case 2: // Struck Bell
        {
            ...
            ap.allOsc (params::volumeSuffix,  [] (int n) { return 0.9 / std::pow ((double) n, 0.8); });
            ap.allOsc (params::attackSuffix,  [] (int)   { return 0.001; });
            ap.allOsc (params::sustainSuffix, [] (int)   { return 0.0; });
            // Higher partials die away first, which is what makes a struck body sound struck.
            ap.allOsc (params::decaySuffix,   [] (int n) { return 6.0 / (1.0 + 0.35 * (n - 1)); });
            ap.allOsc (params::releaseSuffix, [] (int n) { return 6.0 / (1.0 + 0.35 * (n - 1)); });
            break;
        }
        ...
        case 3: // Slow Pad
        {
            ...
            ap.allOsc (params::volumeSuffix,  [] (int n) { return n <= 16 ? 1.0 / n : 0.0; });
        ...
        case 4: // Odd Harmonics
        {
            ...
            ap.allOsc (params::volumeSuffix,  [] (int n) { return (n % 2) ? 1.0 / n : 0.0; });
        ...
        case 6: // Equal Saw
        {
            ...
            // The pair exists to be A/B'd: identical but for the tuning of every partial.
        ...
        case 7: // Shimmer
        {
            ...
            ap.allOsc (params::volumeSuffix,  [] (int n) { return n == 1 ? 0.6 : (n >= 8 ? 0.5 / std::sqrt ((double) n) : 0.0); });

...
OvertoniumLookAndFeel::OvertoniumLookAndFeel()
{
    ...
    setColour (juce::PopupMenu::highlightedBackgroundColourId, colours::accent.withAlpha (0.28f));
...
juce::Font OvertoniumLookAndFeel::getComboBoxFont (juce::ComboBox&)      { return makeFont (12.0f); }
juce::Font OvertoniumLookAndFeel::getPopupMenuFont()                     { return makeFont (14.0f); }
juce::Font OvertoniumLookAndFeel::getSliderPopupFont (juce::Slider&)     { return makeFont (13.0f, true); }

void OvertoniumLookAndFeel::drawRotarySlider (juce::Graphics& g, int x, int y, int width, int height,
...
void OvertoniumLookAndFeel::drawLinearSlider (juce::Graphics& g, int x, int y, int width, int height,
                                              ...
                                              juce::Slider::SliderStyle style, juce::Slider& slider)
{
    ...
    const auto fillTop = juce::jlimit (bounds.getY(), bounds.getBottom(), sliderPos);
    ...
    const juce::Rectangle<float> cap (bounds.getX() + 1.0f,
                                      fillTop - capH * 0.5f,
...
void OvertoniumLookAndFeel::drawButtonBackground (juce::Graphics& g, juce::Button& button,
                                                  ...
                                                  bool shouldDrawButtonAsDown)
{
    ...
    g.setColour (button.getToggleState() ? fill.brighter (0.25f) : colours::outline);
    g.drawRoundedRectangle (bounds, corner, 1.0f);
}

void OvertoniumLookAndFeel::drawButtonText (juce::Graphics& g, juce::TextButton& button,
                                            bool, bool)
{
...
void OvertoniumLookAndFeel::drawComboBox (juce::Graphics& g, int width, int height, bool,
